...
$authorMetaTags
  ...
  <meta name="citation_pdf_url" content="${Env.baseUrl}/${journal.domain}/article/${article.id}/article.pdf">
 ...
 <script type="application/ld+json">
{
  ...
  "url": "${Env.baseUrl}/${journal.domain}/articles/${article.id}",
  "sameAs": "${article.pdf}"
}
</script>
            ...
            <div class="article-meta mt-3">
              <div class="d-flex flex-column flex-md-row justify-content-between align-items-start">
                ...
                <div class="mt-3 mt-md-0 ms-md-4">
                  <a href="${Env.baseUrl}/${journal.domain}/article/${article.id}/article.pdf" class="btn btn-primary" target="_blank" rel="noopener noreferrer">
